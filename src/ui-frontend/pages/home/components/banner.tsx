  ...
  return (
    <div className="before:content-[''] before:absolute before:inset-0 before:z-[3] before:bg-fixed before:bg-[url('statics/images/grid.png')]">
      <div className="relative overflow-hidden h-auto">
        ...
        <div className=""></div>
        {/**内容模块 Center Content*/}
        <div className="w-full h-screen bg-[top_center] bg-no-repeat bg-fixed bg-cover z-[-1] bg-[url('https://api.mtyqx.cn/api/random.php')]">
          {/**Focusinfo */}
          <div className="relative max-w-[800px] px-[0_10px] top-1/2 left-1/2 -translate-1/2 text-center z-100 transition-all duration-400 ease-in-out md:block hidden">
            ...
            <div className="before:content-[''] before:absolute before:top-[-30px] before:left-1/2 before:ml-[-10px] before:border-[15px] before:border-solid before:border-transparent before:border-b-black/50">
              <div className="relative w-[63%] m-auto text-[16px] text-[#eaeadf] bg-black/50 p-[15px] mt-[22px] leading-7.5 rounded-2xl box-content whitespace-nowrap">
