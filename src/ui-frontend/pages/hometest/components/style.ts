...
import grid from "../../../../../public/statics/images/grid.png";
...
export const BannerWrapper = styled.div`
  ...
  .waveTop {
    background-image: url("statics/images/wave-top.png");
  }
  .waveMiddle {
    background-image: url("statics/images/wave-mid.png");
  }
  .waveBottom {
    background-image: url("statics/images/wave-bot.png");
  }
  .headertop-down {
    position: absolute;
    bottom: 80px;
...
export const Focusinfo = styled.div`
  ...
  .top-social_v2 li {
    ...
    float: left;
    margin: 0 6px;
    cursor: url("statics/images/ayuda.cur"), auto;
    position: relative;
  }
  .top-social_v2 li {
    .img-box {
